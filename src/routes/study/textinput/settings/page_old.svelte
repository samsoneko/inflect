...
<div class="saber-panel-default">
    {#each availableCategories as category, i}
        ...
        {#each availableCategoryData[i] as category_data}
            <div>
                <input type="checkbox" name={category_data} value={category_data} bind:group={activeCategorySelectors[i]}/>
...
<div class="center-text bottom-buttons">
    ...
    <button class="saber-button-default saber-color-error" aria-label="Reset Selection" onclick={resetSelection}>
